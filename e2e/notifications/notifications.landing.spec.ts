...
test.fixme('Notifications show up in the table', async ({ page }) => {
...
test.fixme('Delete notification', async ({ page }) => {
  await page.goto('/user/notifications', { timeout: 60000 });
...
test.fixme('Filter notifications', async ({ page }) => {
  await page.goto('/user/notifications', { timeout: 60000 });
...
test.fixme('Search menus are correct', async ({ page }) => {
  await page.goto('/user/notifications', { timeout: 60000 });
...
test.fixme('Action: search', async ({ page }) => {
  await page.goto('/user/notifications', { timeout: 60000 });
...
test.fixme('Enable disable notification', async ({ page }) => {
  await page.goto('/user/notifications', { timeout: 60000 });
  await page.getByTestId('action-btn').nth(0).click();
