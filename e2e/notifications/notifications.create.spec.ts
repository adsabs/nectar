...
test.fixme('Add arxiv notification', async ({ page }) => {
...
test.fixme('Add citations notification', async ({ page }) => {
  await page.goto('/user/notifications', { timeout: 60000 });
...
test.fixme('Add authors notification', async ({ page }) => {
  await page.goto('/user/notifications', { timeout: 60000 });
  await page.getByTestId('create-noti-btn').click();
...
test.fixme('Add keyword notification', async ({ page }) => {
  await page.goto('/user/notifications', { timeout: 60000 });
  await page.getByTestId('create-noti-btn').click();
...
test.fixme('Add query notification', async ({ page }) => {
  // search page
