...
export const AbstractPreview = ({ id }: IAbstractPreviewProps): React.ReactElement => {
  const [state, send] = useMachine(abstractPreviewMachine.withContext({ ...abstractPreviewInitialState, id }), { devTools: true });
  ...
  return <div className="flex">
    <button onClick={handleShowAbstractClick} disabled={state.matches('failure')}>{
