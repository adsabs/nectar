...
export const TextInput = React.forwardRef<HTMLInputElement, ITextInputProps>(
  (props, ref): React.ReactElement => {
    ...
    const labelStyles = typeof classes.label === 'string' ? classes.label : 'block text-gray-700 text-sm font-bold';
    ...
    const helptextStyles = clsx(
      typeof classes.helptext === 'string' ? classes.helptext : 'prose-sm prose text-gray-500',
    );
    ...
    if (typeof label === 'string') {
      ...
      return (
        <>
          ...
          <div className="mt-1">
            <input ref={ref} id={id} {...props} type="text" className={inputStyles} />
          </div>
