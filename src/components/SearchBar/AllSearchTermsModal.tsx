...
export const AllSearchTermsModal = ({ onSelect }: IAllSearchTermsModalProps): ReactElement => {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose} size="xl" scrollBehavior="inside" returnFocusOnClose={false}>
        <ModalOverlay />
        <ModalContent color={colors.text} backgroundColor={colors.background}>
          <ModalBody p={0}>
            ...
            >
              {current ? (
                <>
                  ...
                  <Text
                    ...
                    dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(current.description) }}
                  />
                  <Text fontSize="xs" color={colors.disabledText} mt={1} data-testid="allSearchTermsDetailSyntax">
                    Syntax:{' '}
                  ...
                  <Text fontSize="xs" color={colors.disabledText} mt={1} data-testid="allSearchTermsDetailExample">
                    Example:{' '}
              ...
              <Flex mt={2} gap={3} fontSize="xs" color={colors.disabledText}>
                <Text>
