export const bibstems: string[] = [
  ...
  'BRIOA$$Boletin Real Instituto y Observatorio de la Armada (San Fernando, Cadiz)',
  ...
  'RosOB$$Observatorio Astronomico Municipal de Rosario Argentia',
  'Obs$$The Observatory',
  ...
  'SpPol$$Space Policy',
  'SpPow$$Space Power',
  'SPRMD$$Space Power - Resources, Manufacturing and',
