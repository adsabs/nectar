export type BibstemItem = string[];

export const bibstems: BibstemItem[] = [
  ['TDM', '2D Materials'],
  ['TDR', '3D Research'],
  ['AASHS', 'AAS Hist. Ser.'],
  ['nova pres', 'AAS Nova Highlights'],
  ...
  [
    'AbhKP',
    'Abh. Konigl. Preuss. Akad. Wissenschaften Jahre 1906,92, Berlin,1907',
  ],
  ...
  [
    'CR2',
    'Academie des Sciences Comptes Rendus Serie Mecanique Physique Chimie Sciences de la Terre et de l Univers',
  ],
  ...
  [
    'CRASG',
    'Academie des Sciences Paris Comptes Rendus Serie Generale La Vie des Sciences',
  ],
  [
    'CRASP',
    'Academie des Sciences Paris Comptes Rendus Serie Physique Astrophysique',
  ],
  [
    'CRASM',
  ...
  [
    'CRASA',
    'Academie des Sciences Paris Comptes Rendus Vie Academique Semester Supplement',
  ],
  ['MeARB', 'Academie Royale de Belgique Classe des Sciences Memoires'],
  [
    'ASSAB',
    'Academie Serbe des Sciences et des Arts Bulletin Classe des Sciences Techniques',
  ],
  [
    'ASLLR',
  ...
  [
    'ANLAM',
    'Accademia Nazionale dei Lincei Atti Rendiconti Classe di Matematica e Applicazioni',
  ],
  [
    'ANLAF',
    'Accademia Nazionale dei Lincei Atti Rendiconti Classe di Scienze Fisiche e Naturali',
  ],
  [
    'ANLAR',
    'Accademia Nazionale dei Lincei Atti Rendiconti Classe di Scienze Fisiche Matematiche e Naturali',
  ],
  ...
  ['AcAT', 'Acta Astrophysica Taurica'],
  ...
  ['AcGG', 'Acta Geodaetica et Geophysica'],
  ...
  [
    'IFBel',
    'Akademiia Nauk Belorusskoi SSR Institut Fiziki Nauchnaia Sessiia Minsk Belorussian SSR Zhurnal Prikladnoi Spektroskopii',
  ],
  ...
  [
    'IzMol',
    'Akademiia Nauk Moldavskoi SSR Izvestiia Seriia Fiziko Tekhnicheskikh i Matematicheskikh Nauk',
  ],
  ...
  [
    'FiMos',
    'Akademiia Nauk SSSR Otdelenie Obshchei Fiziki i Astronomii Nauchnaia Sessiia Moscow USSR Uspekhi Fizicheskikh Nauk',
  ],
  ...
  [
    'KzSib',
    'Akademiia Nauk SSSR Sibirskoi Otdelenie Izvestiia Seriia Tekhnicheskikh Nauk',
  ],
  ['VeSSR', 'Akademiia Nauk SSSR Vestnik'],
  ['DoTad', 'Akademiia Nauk Tadzhikskoi SSR Doklady'],
  [
    'FiSSR',
    'Akademiia Nauk Tadzhikskoi SSR Fiziko Tekhnicheskii Institut Dyushambe Tadzhik SSR Akademiia Nauk Tadzhikskoi SSR Doklady',
  ],
  [
    'IzTur',
  ...
  [
    'FiUkr',
    'Akademiia Nauk Ukrain skoi RSR Dopovidi Seriia Fiziko Matematichni ta Tekhnichni Nauki',
  ],
  ['IzUkr', 'Akademiia Nauk Ukrainian SSSR Izvestiia Seriia Fizicheskaia'],
  [
    'PrUkr',
    'Akademiia Nauk Ukrains koi RSR Dopovidi Matematika Prirodoznavstvo Tekhnichni Nauki',
  ],
  [
    'DoUkr',
  ...
  [
    'MGUkr',
    'Akademiia Nauk Ukrainskoi SSR Morskie Gidrofizicheskie Issledovaniia',
  ],
  ['DoUzb', 'Akademiia Nauk Uzbekskoi SSR Doklady'],
  [
    'IzUzb',
    'Akademiia Nauk Uzbekskoi SSR Izvestiia Seriia Fiziko Matematicheskikh Nauk',
  ],
  ...
  [
    'CSPSE',
    'Ankara Universite Faculte des Sciences Communications Serie Mathematiques Physique et Astronomie',
  ],
  [
    'CSMPA',
    'Ankara University Faculty of Science Communications, Series A2-Ad Physical Sciences and Engineering',
  ],
  ...
  ['ASSB', 'Annales de la Société Scientifique de Bruxelles'],
  ...
  [
    'AnAIK',
    "Annales de l'Observatoire astronomique de l'Université imériale de Kharkow",
  ],
  ['AOTok', "Annales de l'Observatoire astronomique de Tokyo"],
  ['AnZoC', "Annales de l'Observatoire astronomique de Zô-sè (Chine)"],
  [
    'AnAPM',
    "Annales de l'Observatoire d'astronomie physique de Paris, Section d'astrophysique, à Meudon",
  ],
  ...
  ['AnRMS', 'Annual Review of Materials Research'],
  ...
  [
    'IORAS',
    'Anuario publicado pelo Imperial Observatorio do Rio de Janeiro Suplemento',
  ],
  ...
  [
    'AMGBK',
    'Archiv Meteorologie Geophysik und Bioklimatologie Serie B Klimatologie und Umweltmeteorologie Strahlungsforschung',
  ],
  [
    'AMGBS',
    'Archiv Meteorologie Geophysik und Bioklimatologie Serie Meteorologie und Geophysik',
  ],
  ...
  ['AMCE', 'Archiveds of Civil and Mechanical Engineering'],
  ['ArAco', 'Archives Acoustics'],
  ['ArS', 'Archives des Sciences'],
  ['ArSPN', 'Archives des Sciences Physiques et Naturelles'],
  [
    'AMGBA',
    'Archives for Meteorology Geophysics and Bioclimatology Series A Meteorology and Atmopsheric Physics',
  ],
  [
    'AMGBB',
  ...
  ['APCRS', 'Archives of Photogrammetry, Cartography and Remote Sensing'],
  ...
  ['ATJEM', 'ASME Journal Engineering Materials and Technology'],
  ['ATJAM', 'ASME Journal of Applied Mechanics'],
  ['ATJDS', 'ASME Journal of Dynamic Systems and Measurement Control B'],
  ['ATJEl', 'ASME Journal of Electronic Packaging'],
  ['ATJEG', 'ASME Journal of Engineering Gas Turbines and Power'],
  ['ATJEP', 'ASME Journal of Engineering Power'],
  ['ATJFE', 'ASME Journal of Fluids Engineering'],
  ['ATJHT', 'ASME Journal of Heat Transfer'],
  ['ATJLT', 'ASME Journal of Lubrication Technology'],
  ['ATJSE', 'ASME Journal of Solar Energy and Engineering'],
  ['ATJTr', 'ASME Journal of Tribology'],
  ['ATJTu', 'ASME Journal of Turbomachinery'],
  ['ATJVA', 'ASME Journal of Vibration Acoustics'],
  [
    'AAABS',
    'Asociacion Argentina de Astronomia La Plata Argentina Book Series',
  ],
  ['APPSB', 'Association of Asia Pacific Physical Societies Bulletin'],
  ['ATMAB', 'Association Technique Maritime et Aeronautique Bulletin'],
  [
    'ATMAS',
    'Association Technique Maritime et Aeronautique Session Paris France ONERA TP',
  ],
  ['Aster', 'Aster'],
  ...
  [
    'AAAN',
    'Astronomische Abhandlungen als Erganzungshefte zu den Astronomische Nachrichten',
  ],
  ...
  [
    'ABKie',
    'Astronomische Beobachtungen auf der Sternwarte der Koeniglichen Christian-Albrechts-Universitaet zu Kiel',
  ],
  ...
  [
    'MiGoe',
    'Astronomische Mitteilungen der Universitaets-Sternwarte zu Goettingen',
  ],
  ...
  [
    'AZWis',
    'Astronomisches Zirkular der Akademie der Wissenschaften der UdSSR',
  ],
  ['ATi', 'Astronomisk Tidsskrift'],
  ['As&Ge', 'Astronomiya i geodeziya'],
  ['Ast', 'Astronomy'],
  ['Astro', 'Astronomy'],
  ['A&AC', 'Astronomy & Astrophysics (Caucasus)'],
  ...
  ['AtmEB', 'Atmospheric Environment Part B'],
  ...
  [
    'BAVSR',
    'BAV Rundbrief - Mitteilungsblatt der Berliner Arbeits-gemeinschaft fuer Veraenderliche Sterne',
  ],
  [
    'BAWMN',
    'Bayerische Akademie Wissenschaften mathematisch naturwissenschaftliche Klasse Sitzungsberichte',
  ],
  ...
  [
    'BROGS',
    'Belgian Royal Observatory Communications Series Geophysics Series',
  ],
  ...
  [
    'BBGPC',
    'Berichte der Bunsen-Gesellschaft Physical Chemistry Chemical Physics Berichte',
  ],
  [
    'BADPG',
    'Berlin East Germany Akademie Verlag GmbH Ergebnisse Plasmaphysik und Gaselektronik',
  ],
  [
    'BAVMM',
    'Berlin East Germany Akademie Verlag GmbH Shriftenreihe des Zentralinstituts Mathematik und Mechanik',
  ],
  ['BGBGM', 'Berlin Gebrueder Borntraeger Geoexploration Monographs Series'],
  [
    'BAVSM',
    'Berliner Arbeitsgemeinschaft fuer Veraenderliche Sterne - Mitteilungen',
  ],
  ...
  [
    'BOTor',
    'Biuletyn Obserwatoium Astronomicznego Uniwersytetu M. Kopernika w Toruniu',
  ],
  [
    'BITad',
    'Biulletini of the Astronomical Institute Akademiia Nauk Tadzhikskoi',
  ],
  ...
  [
    'BIMAF',
    'Boletin del Instituto de Matematica Astronomica y Fisica Universidad Nacional de Cordoba Argentina',
  ],
  ['BITon', 'Boletin del Instituto de Tonantzintla'],
  ['BMOE', 'Boletin mensual del Observatorio del Ebro'],
  [
    'BRIOA',
    'Boletin Real Instituto y Observatorio de la Armada (San Fernando, Cadiz)',
  ],
  ...
  [
    'BSSR',
    'AN BSSR Institut Teplo i Massoobmena Vsesoiuznaia Konferentsiia Teplomassoobmenu Minsk Belorussian SSR Preprint',
  ],
  ...
  [
    'BlTek',
    'Bulgarska Akademiia Naukite Institut Tekhnicheska Kibernetika Izvestiia',
  ],
  ['BlMat', 'Bulgarska Akademiia Naukite Matematicheski Institut Izvestiia'],
  ['BlSpi', 'Bulgarska Akademiia Naukite Spisanie'],
  [
    'BlTse',
    'Bulgarska Akademiia Naukite Tsentralna Laboratoriia Geodeziia Izvestiia',
  ],
  ...
  [
    'BSASP',
    'Bulletin de la Societe des Amis des Sciences et des Lettres de Poznan',
  ],
  ['BSRSL', 'Bulletin de la Societe Royale des Sciences de Liege'],
  ['BMai', 'Bulletin de la Station Astrophotographique de Mainterne'],
  [
    'BAPSS',
    "Bulletin de l'Academie Polonaise des Sciences Series des Sciences Mathematiques Astronomiques et Physiques",
  ],
  ['BARB', "Bulletin de l'Academie Royale de Belgique"],
  [
    'AFOEV',
    "Bulletin de l'Association Francaise d'Observateurs d'Etoiles Variables",
  ],
  ['BOBeo', "Bulletin de l'Observatoire Astronomique de Belgrade"],
  ['BuLyo', "Bulletin de l'Observatoire de Lyon"],
  [
    'BBSAG',
    'Bulletin der Bedeckungsveraenderlichen-Beobachter der Schweizerischen Astronomischen Gesellschaft',
  ],
  ...
  [
    'BuONC',
    'Bulletin of the Special Astrophysical Observatory, Northern Caucasus',
  ],
  ...
  ['BuYer', 'Bulletin of the Yerevan Astronomical Observatory'],
  ['YerOB', 'Bulletin of the Yerkes Observatory of the University of Chicago'],
  ['BAST', 'Bulletin of Atmospheric Science and Technology'],
  ...
  [
    'BCNRS',
    'Bulletin Signaletique - Centre National de la Recherche Scientifique',
  ],
  ...
  [
    'BStaO',
    "Byulleten' Stalinabadskoj Astronomicheskoj Observatorii Akademiya Nauk Tadzhikskoj SSR",
  ],
  ...
  [
    'BCNRC',
    'Canada National Research Council Division Mechanical Engineering National Aeronautical Establishment Quarterly Bulletin',
  ],
  ...
  ['CRPS', 'Cell Reports Physical Science'],
  ['Cent', 'Centaurus'],
  ...
  [
    'MonAP',
    "Communications du Departement d'Astrophysique de la Faculte des Sciences de Mons Mons Astrophysical Papers",
  ],
  ['ComEE', 'Communications Earth and Environment'],
  ['CoDDO', 'Communications from the David Dunlap Observatory'],
  ['CoROE', 'Communications from the Royal Observatory Edinburgh'],
  [
    'CoStA',
    'Communications from the University Observatory St Andrews Scotland',
  ],
  ...
  [
    'CoAnk',
    'Communications of the Department of Astronomy of Ankara University',
  ],
  ...
  [
    'CRSPH',
    "Compte Rendu des Seances de la Societe de Physique et d'Histoire Naturelle de Geneve",
  ],
  ...
  [
    'CoCoi',
    'Comunicacoes do Observatonio Astronomico da Universidade de Coimbra',
  ],
  ...
  [
    'CoFra',
    'Consiglio Nazionale delle Ricerche Italia. Laboratorio di Astrofisica Frascati Roma Contributi',
  ],
  ...
  [
    'CoAsi',
    "Contributi dell'Osservatorio Astrofisica dell'Universita di Padova in Asiago",
  ],
  ...
  [
    'CoThe',
    'Contributions from the Astronomical Department of the University of Thessaloniki',
  ],
  ...
  [
    'CoDAO',
    'Contributions from the Dominion Astrophysical Observatory in Victoria',
  ],
  ['CoDun', 'Contributions from the Dunsink Observatory Dublin Ireland'],
  [
    'CoKyo',
    'Contributions from the Institute of Astrophysics and Kwasan Observatory Kyoto',
  ],
  ['CoKit', 'Contributions from the Kitt Peak National Observatory'],
  [
    'CoKwa',
    'Contributions from the Kwasan and Hida Observatories University of Kyoto',
  ],
  [
    'CoMcD',
    'Contributions from the McDonald Observatory University of Texas Fort Davis',
  ],
  [
    'CMWCI',
  ...
  [
    'CoSkL',
    'Contributions of the Astronomical Observatory Skalnate Pleso Letters',
  ],
  [
    'CoSkS',
    'Contributions of the Astronomical Observatory Skalnate Pleso Supplement',
  ],
  [
    'CoLou',
  ...
  [
    'CONMS',
    'Contributions of the Observatory of New Mexico State University, Las Cruces Special Series',
  ],
  ...
  [
    'ConAP',
    'Contributions to Atmospheric Physics/Beitraege zur Physik der Atmosphaere',
  ],
  ...
  [
    'CAGHS',
    'Correspondance Astronomique, Geographique, Hydrographique et statistique',
  ],
  ...
  ['CRSSM', 'Critical Reviews in Solid State & Material Sciences'],
  ['Cryo', 'Cryogenics'],
  ['TCry', 'The Cryosphere'],
  ...
  ['CTBio', 'Current Topics in Biophysics'],
  ...
  [
    'Sterb',
    'Der Sternenbote Monatsschrift fuer Oesterreichs Amateur-astronomen',
  ],
  ['DGKBA', 'Deutsche Geodaetische Kommission Bayer. Akad. Wiss.'],
  ['DGKBB', 'Deutsche Geodaetische Kommission Bayer. Akad. Wiss. B'],
  [
    'DGKGN',
    'Deutsche Geodaetische Kommission Gravity Network West Germany DSGN Data Adjustment',
  ],
  ...
  ['Disc', 'Discover'],
  ['DiEne', 'Discover Energy'],
  ['DiMat', 'Discover Materials'],
  ['DiSus', 'Discover Sustainability'],
  ['DiWat', 'Discover Water'],
  ...
  ['EGSGA', 'E&G Quaternary Science Journal'],
  ...
  ['EScIn', 'Earth Science Informatics'],
  ...
  ['ECSIn', 'ECS Interface Magazine'],
  ['ECSMA', 'ECS Meeting Abstracts'],
  ['ECSTr', 'ECS Transactions'],
  ['Earth', 'eEarth'],
  ...
  [
    'ETRE',
    'Elektrosviaz Telecommunications Radio Engineering Telecommunications',
  ],
  ...
  ['EPJNS', 'EPJ Nuclear Sciences & Technologies'],
  ...
  [
    'PMtv',
    'Facultad de Humanidades y Ciencias Universidad de la Republica Montevideo',
  ],
  ...
  [
    'Gerb',
    'Gerbertvs, International Academic Publication on History of Medieval Science',
  ],
  ['GBzG', 'Gerlands Beitraege zur Geophysik'],
  ['GUL', 'Geschichte und Lichtwechsel der Veraenderlichen Sterne (Potsdam)'],
  [
    'GATAN',
    'Gesellschaft Aerosolforschung Tagung ueber Aerosole Naturwissenschaft Medizin und Technik Messtechnik und technische Anwendung',
  ],
  [
    'GMMWJ',
  ...
  [
    'GMuD',
    'Gesellschaft Mathematik und Datenverarbeitung mbH Multigrid Methods Special Topics Applications',
  ],
  ...
  [
    'HARSB',
    "Histoire de l'Academie Royale des Sciences et des Belles-Lettres de Berlin",
  ],
  ...
  [
    'BSEEA',
    'Iasi Institutul Politehnic Buletinul Sectia Electrotehnica Electronica Automatizari',
  ],
  [
    'BSMMT',
    'Iasi Institutul Politehnic Buletinul Sectia Matematica Mecanica Teoretica Fizica',
  ],
  ...
  ['imsd conf', 'IEEE MTT-S International Microwave Symposium Digest'],
  ['IEEEN', 'IEEE Network'],
  ...
  ['IPDMC', 'IEEE Press Series on Digital & Mobile Communication'],
  ...
  [
    'ITJSE',
    'Indian Institute of Technology Journal on Section Engineering Technology',
  ],
  ...
  [
    'InJP',
    'Indian Journal of Physics and Proceedings of the Indian Assocatiation for the Cultivation of Science',
  ],
  ...
  [
    'IAOIT',
    'Informo of the Astronomia-Optika Institucio, Universitato de Turku',
  ],
  ...
  [
    'IPAUC',
    'INTERKOSMOS Prague Astronomicky Ustav Ceskoslovenske Akademie Ved',
  ],
  ...
  ['IJART', 'International Journal of Advancements in Research & Technology'],
  ...
  [
    'IJRAI',
    'International Journal of Radiation Applications and Instrumentation D Nuclear Tracks and Radiation Measurements',
  ],
  ...
  [
    'IsJAP',
    'Istanbul University Faculty of Science Journal of Astronomy Physics',
  ],
  ...
  [
    'JWUDF',
    'Jahns Wöchentliche Unterhaltungen Für Dilettanten und Freunde der Astronomie, Georgraphie und Witterungskunde',
  ],
  ...
  ['JES', 'Journal of the Earth Simulator'],
  ...
  ['JMeSJ', 'Journal of the Meteorological Society of Japan'],
  ...
  [
    'JASE',
    'Journal of Applied Science and Engineering Section on Electrical Power and Information Systems',
  ],
  ...
  ['JAESE', 'Journal of Astronomy & Earth Sciences Education'],
  ...
  ['JCBC', 'Journal of Computational Biophysics and Chemistry'],
  ...
  ['JEET', 'Journal of Electrical Engineering & Technology'],
  ...
  ['JMNMM', 'Journal of Micro/Nanopatterning, Materials, and Metrology'],
  ...
  ['JNWPU', 'Journal of Northwestern Polytechnical University'],
  ...
  ['JPhCB', 'Journal of Physical Chemistry B'],
  ...
  ['JPCom', 'Journal of Physics: Complexity'],
  ...
  [
    'JRNBA',
    'Journal of Research of the National Bureau of Standards A Physica and Chemsitry',
  ],
  [
    'JRNBB',
  ...
  ['JSedE', 'Journal of Sedimentary Environments'],
  ...
  ['JSSST', 'Journal of Solid State Science and Technology'],
  ...
  [
    'KNAB',
    'Koninklijke Nederlandse Akademie van Wetenschappen Proceedings Series B Physical Sciences',
  ],
  ...
  [
    'PrAtO',
    'Leningrad Gidrometeoizdat Sovremennye Problemy Atmosfernoi Optiki',
  ],
  ...
  [
    'LGUPM',
    'Leningradskii Gosudarstvennyi Universitet Problemy Matematicheskoi Fiziki',
  ],
  [
    'VeLen',
  ...
  [
    'MAWMN',
    'Mainz Akademie Wissenschaften Mathematisch Naturwissenschaftliche Klasse',
  ],
  ['Lapa', 'Majalah LAPAN'],
  ...
  ['MGQG', 'Marine Geology & Quaternary Geology'],
  ...
  ['MatQT', 'Materials for Quantum Technology'],
  ...
  [
    'MeLeu',
    'Mededelingen van het Astronomisch Instituut van de Katholieke Universiteit Leuven',
  ],
  ...
  ['MelAR', 'Melbourne Observatory Annual Reports'],
  ...
  ['MetRT', 'Metallurgical Research & Technology'],
  ...
  ['MpNp', 'Microplastics and Nanoplastics'],
  ...
  [
    'MiBas',
    'Mitteilungen der Astronomisch-Meteorologischen Anstalt der Universitaet Basel Astronomische Reihe',
  ],
  ...
  [
    'MiTue',
    'Mitteilungen des Astronomischen Instituts der Universitaet Tuebingen',
  ],
  [
    'MiMue',
    'Mitteilungen des Astronomischen Instituts des Universitaet Munster',
  ],
  ['MiPot', 'Mitteilungen des Astrophysikalischen Observatoriums Potsdam'],
  [
    'MiGIR',
    'Mitteilungen Geod. Institut Rheinischen Friedrich-Wilhelms-Universitaets. Bonn',
  ],
  ...
  [
    'MoINI',
    'Moscow Izdatel Nauka Issledovaniia Geomagnetizmu Aeronomii i Fizike Solntsa',
  ],
  ...
  [
    'MoMTN',
    'Moscow Mezhdunarodnyi Tsentr Nauchnoi i Tekhnicheskoi Informatsii',
  ],
  ...
  [
    'MGUMN',
    'Moskovskii Gosudarstvennyi Universitet Institut Mekhaniki Nauchnye Trudy',
  ],
  ...
  [
    'MGTVM',
    'Moskovskij Gosudarstvennyj Tekhnicheskij Universitet Vestnik Seriya Mashinostroenie',
  ],
  [
    'MGTVP',
    'Moskovskij Gosudarstvennyj Tekhnicheskij Universitet Vestnik Seriya Priborostroenie',
  ],
  ...
  ['MRSAd', 'MRS Advances'],
  ['MRSBu', 'MRS Bulletin'],
  ['MRSCo', 'MRS Communications'],
  ['MRSES', 'MRS Energy and Sustainability'],
  ...
  [
    'NWGot',
    'Nachrichten von der Gesellschaft der Wissenschaften zu Goettingen, Mathematisch-Physikalische Klasse',
  ],
  ...
  ['adap prop', 'NASA ADAP Proposal'],
  ['apra prop', 'NASA APRA Proposal'],
  ['atp', 'prop', 'NASA ATP Proposal'],
  ['NASCL', 'NASA Circular Letter'],
  ['oss', 'prop', 'NASA OSS Proposal'],
  ...
  ['wfir prop', 'NASA WFIRST Proposal'],
  ['wps', 'prop', 'NASA WPS Proposal'],
  ...
  [
    'BAth',
    'National Observatory of Athens Greece Bulletin of the Astronomical Institute',
  ],
  ...
  [
    'ICHIN',
    'Newsletters of the Interdivisional Commission on History of the IAGA',
  ],
  ['NKG', 'Nihon Kessho Gakkaishi'],
  ['NihOC', 'Nihondaira Observatory Circular'],
  [
    'NOHIC',
    'Nizamiah JAPAL Rangapur Observatories Hyderabad India Contributions',
  ],
  ['noao prop', 'NOAO Proposal'],
  ['Mirro', 'The NOIRLab Mirror'],
  ...
  [
    'NovIG',
    'Novosibirsk Institut Gidrodinamiki SO AN SSSR Dinamika Sploshnoi Sredy',
  ],
  ...
  [
    'NOSCA',
    'Observaciones Astronomicas Hechas en el Observatorio de Santiago de Chile',
  ],
  ...
  [
    'RosOB',
    'Observatorio Astronomico Municipal de Rosario Argentia',
    'Boletin',
  ],
  ['Obs', 'The Observatory'],
  [
    'HelR',
    'Observatory and Astrophysics Laboratory University of Helsinki Report',
  ],
  ...
  [
    'OccN',
    'Occultation Newsletter, International Occultation Timing Association (IOTA)',
  ],
  ...
  [
    'BOOde',
    'Odesskij Gosudarstvennyi Universitet im. I. I. Mechnikova Byulletin Astronomicheskoj Observatorii',
  ],
  [
    'IzOde',
    'Odesskij Gosudarstvennyi Universitet im. I. I. Mechnikova Izvestiya Astronomicheskoj Observatorii',
  ],
  ['Oecol', 'Oecologia'],
  [
    'OAWMN',
    'Oesterreichische Akademie Wissenschaften Mathematisch naturwissenschaftliche Klasse Sitzungsberichte Abteilung',
  ],
  ['Okean', 'Okeanologiia'],
  ['ONCP', 'Old and New Concepts of Physics'],
  [
    'OCzAS',
    'Ondrejov Czechoslovakia Czechoslovak Academy Sciences CAS Astronomical Institute Publications',
  ],
  ['ONERA', 'ONERA TP'],
  ...
  ['PaPa', 'Paleoceanography and Paleoclimatology'],
  ...
  ['PAIJ', 'Physics & Astronomy International Journal'],
  ...
  [
    'PCMLA',
    'Physics and Chemistry of Materials with Low-Dimensional Structures Series A',
  ],
  [
    'PCMLB',
    'Physics and Chemistry of Materials with Low-Dimensional Structures Series B',
  ],
  [
    'PCMLC',
    'Physics and Chemistry of Materials with Low-Dimensional Structures Series C',
  ],
  ...
  [
    'PCZNN',
    'Politechnika Czestochowska Zeszyty Naukowe Nauki Techniczne Mechanika',
  ],
  ...
  ['PrIA', 'Proceedings of the Imperial Academy'],
  [
    'PIASE',
    'Proceedings of the Indian Academy of Science, Earth and Planetary Sciences',
  ],
  ...
  [
    'PIGP',
    'Proceedings of the Institute of General Physics, Adademy of the Sciences of Russia',
  ],
  [
    'PIAHS',
  ...
  [
    'PILOM',
    'Proceedings of the International Latitude Observatory at Mizusawa',
  ],
  ['PIRE', 'Proceedings of the IRE'],
  ['PJAB', 'Proceedings of the Japan Academy, Series B'],
  ...
  ['PSNAS', 'Proceedings of the Singapore National Academy of Science'],
  ...
  [
    'PIAGL',
    "Publications de l'Institut d'Astronomie et de Geophysique Georges Lemaitre",
  ],
  ['POBeo', "Publications de l'Observatoire Astronomique de Beograd"],
  [
    'PASK',
    'Publications of the Academy of Science Kasakstan Sect. Astrobotanics',
  ],
  [
    'PAllO',
  ...
  [
    'PBrn',
    'Publications of the Astronomical Institute of the University of Borneo',
  ],
  ...
  [
    'PADEU',
    'Publications of the Astronomy Department of the Eotvos Lorand University',
  ],
  ...
  [
    'ILOMP',
    'Publications of the International Latitude Observatory at Mizusawa',
  ],
  ...
  [
    'PUPFA',
    'Publications of the University of Pennsylvania Flower Astronomical Observatory',
  ],
  ...
  [
    'RadA',
    'Radio Astronomy: Journal of the Society of Amateur Radio Astronomers,',
  ],
  ...
  [
    'RTRE',
    'Radiotekhnika Tecommunications Radio Engineering Radio Engineering',
  ],
  ['LeRad', 'Le Radium'],
  ...
  [
    'RSPUT',
    'Report Series of the Department of Physics and Science, University of Turku',
  ],
  [
    'YalRY',
  ...
  [
    'ChPAS',
    'Republic of China National Science Council Proceedings Applied Sciences',
  ],
  ...
  [
    'RvA',
    'Revista Astronomica Organo de la Asociacion Argengina Amigos de la Astronomia Buenos Aires',
  ],
  ...
  [
    'RWPWZ',
    'Rostock Wilhelm Pieck Universitaet Wissenschaftliche Zeitschrift Mathematisch Naturwissenschaftliche Reihe',
  ],
  [
    'PVSS',
    'Royal Astronomical Society of New Zealand Publications of Variable Star Section',
  ],
  [
    'VSSCi',
  ...
  [
    'MaMeA',
    'Sankt Peterburgskii Universitet Vestnik Seriia Matematika Mekhanika Astronomiia',
  ],
  ...
  [
    'SVICP',
    'Shock Vibration Information Center Shock Vibration Computer Programs',
  ],
  ...
  [
    'SFPTB',
    'Societe Francaise de Photogrammetrie et de Teledetection Bulletin',
  ],
  ...
  [
    'SoByu',
    'Soobshcheniya Byurakanskoj Observatorii Akademiya Nauk Armyanskoj SSR Erevan',
  ],
  ...
  [
    'IBSAE',
    'Sovetskaia Antarkticheskaia Ekspeditsiia Informatsionnyi Byulleten',
  ],
  ...
  [
    'SSGSR',
    'Springer Verlag Springer Series on Group Geophysics Space Research',
  ],
  ...
  ['SLJP', 'Sri Lankan Journal of Physics'],
  ['SrLJP', 'Sri Lankan Journal of Physics'],
  [
    'SANUG',
    'Srpska Akademiia Nauka i Umetnosti Glas Odeljenje Tekhnichkikh Nauka',
  ],
  ['SRXPh', 'SRX Physics'],
  ['StSky', 'Star Sky'],
  ...
  [
    'IEWS',
    'Stevenage Herts England Peter Peregrinus Ltd IEE Electromagnetic Waves Series',
  ],
  ['Stiin', 'Stiinta'],
  ...
  [
    'TMPGO',
    'Tagung ueber Mathematische Probleme Geodaesie Oberwolfach West Germany Bulleting Geodesique',
  ],
  ...
  [
    'TeMAE',
    'Terrestrial Magnetism and Atmospheric Electricity (Journal of Geophysical Research)',
  ],
  ...
  [
    'TrTIM',
    'Tiflis Izdatel Metsniereba Akademiia Nauk Gruzinskoi SSR Institut Geofiziki Trudy',
  ],
  [
    'TrGru',
    'Tiflis Izdatel Metsniereba Akademiia Nauk Gruzinskoi SSR Matematicheskii Institut Trudy',
  ],
  ...
  [
    'ToASC',
    'Torino Accademia delle Scienze Classe di Scienze Fisiche Matematiche e Naturali Atti',
  ],
  ...
  [
    'TITas',
    'Tsirkulyar Astronomicheskogo Instituta Akademiya Nauk Uzbekskoj SSR',
  ],
  ...
  [
    'VeKar',
    'Veroeffentlichungen der Grossherzoglichen Sternwarte zu Karlsruhe',
  ],
  ...
  [
    'VeBoc',
    'Veroeffentlichungen des Astronomischen Instituts der Ruhr-Universitaet Bochum',
  ],
  [
    'VeARI',
  ...
  [
    'VeFra',
    'Veroeffentlichungen des Astronomisches Institute der Universitaet Frankfurt',
  ],
  ['VeBKI', 'Veroeffentlichungen des Bayerische Kommission Int. Erdmessung'],
  [
    'VeKAB',
    'Veroeffentlichungen des Koeniglichen Astronomischen Rechen-Instituts zu Berlin',
  ],
  ['VeZPE', 'Veroffentlichungen des Zentralinstituts Physik der Erde'],
  ['VeLdn', 'Verslag van den staat der Sterrewacht te Leiden'],
  [
    'VMKAN',
    'Verslagen en Mededeelingen der Kon. Academie van Wetenschappen, Afd. Natuurkunde',
  ],
  ['Vert', 'Vertica'],
  ['Vertf', 'Vertiflite'],
  ['Vesmi', 'Vesmir'],
  ...
  [
    'VCGFV',
    'VKI Computer Graphics Flow Visualization and Computational Fluid Dynamics',
  ],
  ...
  [
    'VMATP',
    'VKI Modeling and Applications of Transport Phenomena in Porous Media',
  ],
  ...
  [
    'VANTS',
    'Voprosy Atomnoi Nauki i Tekhniki Seriia Fizika Plazmy i Problemy Upravliaemykh Termoiadernykh Reaktsii',
  ],
  ...
  [
    'VMOIP',
    'Voprosy Metrologicheskogo Obespecheniia Izmereniia Parametrov Tekhnologicheskikh Lazerov',
  ],
  ...
  [
    'IzYak',
    'Vsesoiuznaia Konferentsiia Kosmicheskim Lucham Yakutsk USSR Akademiia Nauk SSSR Izvestiia Seriia Fizicheskaia',
  ],
  [
    'IzYer',
    'Vsesoiuznaia Konferentsiia Kosmicheskim Lucham Yerevan Armenian SSR Aademiia Nauk SSSR Izvestiia Seriia Fizicheskaia',
  ],
  ...
  [
    'MiTau',
    'Zentralinstitut fuer Astrophysik Mitteilungen des Karl-Schwarzschild-Observatoriums Tautenburg',
  ],
  [
    'MitVS',
    'Zentralinstitut fuer Astrophysik Sternwarte Sonneberg Mitteilungen ueber Veraenderliche Sterne',
  ],
