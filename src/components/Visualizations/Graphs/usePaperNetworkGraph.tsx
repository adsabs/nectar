import { IADSApiPaperNetworkSummaryGraph, IADSApiPaperNetworkSummaryGraphNode } from '@api';
...
export const usePaperNetworkGraph = (
  ...
  const partition = (
    ...
    const root = d3
      .hierarchy(data)
      .sum((d) => (d.paper_count ? d.paper_count : 0))
  ...
  const paperCounts = useMemo(() => pluck('paper_count', nodes_data), [nodes_data]);
