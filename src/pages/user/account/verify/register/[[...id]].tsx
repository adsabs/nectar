...
const TIMEOUT = 3000;
const VerifyRegistration: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
  ...
  return (
    <Container centerContent size="lg" my="8">
      <Alert status="success">
        ...
        <AlertDescription>Your account has been verified. Redirecting now...</AlertDescription>
      </Alert>
    </Container>
  );
};
